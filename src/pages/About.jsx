   ...
   const infoBoxes = [
      {
         ...
         icon: <GroupsIcon sx={{mr: '3vh', color: "#009ECF"}} />, 
         image: groupPic
      }, 
      {
         text: 'About Our Sessions',
         link: '/sessions', 
         icon: <TerminalIcon sx={{mr: '3vh', color: "#009ECF"}} />, 
         image: whatWeDo
      }, 
      {
         text: 'Contact Us',
         link: '/contact', 
         icon: <SendIcon sx={{mr: '3vh', color: "#009ECF"}} />, 
         image: groupPic2
      }
   ]
      ...
      <ThemeProvider theme={theme}>
         <motion.div style={{ background: 'linear-gradient(60deg, rgba(232,232,232,1.00) 6%,rgba(178,229,247,1.00) 90%)', height: '100%'}}
            ...
            <motion.div className="page-background" style={{ textAlign: 'left', height: '100%', padding: "5vh 5%", width: '90%'}}>
               ...
               <Grid container spacing={2} justifyContent='center' alignItems='center' sx={{my: '5vh'}}>
                     ...
                     >
                        <CardActionArea href={box.link} sx={{'&:hover': { textDecoration: 'unset'}}}>
                           ...
                           <CardContent sx={{display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', textDecoration: 'unset !important',}}>
                              {box.icon}
                              <Typography variant='h6' sx={{fontWeight: '400', alignSelf: 'center'}}>
                                 {box.text}
                              </Typography>
                           </CardContent>
                        </CardActionArea> 
                     ...
                     <Grid container rowSpacing={3}>
                        <Grid item xs={12} md={6}>
                           <Stack direction='row' alignItems='center' spacing={2}>
                              <GroupsIcon sx={{fontSize: '60px', backgroundColor: '#009ECE', borderRadius: '100%', p: '2vh', color: '#fff'}} />
                              <Typography variant='h5' sx={{fontSize: '24px', fontWeight: 300}}>
                                 <span style={{fontWeight: 500}}>22 Facilitators</span> of CWRU graduate and undergraduate students
                              </Typography>
                           </Stack>
                        </Grid>
                        <Grid item xs={12} md={6}>
                           <Stack direction='row' alignItems='center' spacing={2}>
                              <SchoolIcon sx={{fontSize: '60px', backgroundColor: '#009ECE', borderRadius: '100%', p: '2vh', color: '#fff'}} />
            ...
            <Reveal>
               <Stack justifyContent= 'space-around' alignItems='start' spacing={3} sx={{mb: '5vh'}}>
                  ...
                  <Stack direction='row' alignItems='center' spacing={2}>
                     <Diversity2Icon sx={{fontSize: '60px', backgroundColor: '#009ECE', borderRadius: '100%', p: '2vh', color: '#fff',}} />
                     <Typography variant='h5' sx={{fontSize: '24px', fontWeight: 300}}>
            ...
            <Reveal>
               <Stack justifyContent= 'space-around' alignItems='start' spacing={1} sx={{mb: '6vh'}}>
                     ...
                     <Grid container rowSpacing={3}>
                        <Grid item xs={12} md={6}>
                           <Stack direction='row' alignItems='center' spacing={2}>
                              <CodeIcon sx={{fontSize: '60px', backgroundColor: '#009ECE', borderRadius: '100%', p: '2vh', color: '#fff'}} />
                              <Typography variant='h5' sx={{fontSize: '24px', fontWeight: 300}}>
                                 Host <span style={{fontWeight: 500}}>2 weekly sessions</span> introducing programming and problem-solving skills with Python and Arduino
                              </Typography>
                           </Stack>
                        </Grid>
                        <Grid item xs={12} md={6}>
                           <Stack direction='row' alignItems='center' spacing={2}>
                              <Diversity3Icon sx={{fontSize: '60px', backgroundColor: '#009ECE', borderRadius: '100%', p: '2vh', color: '#fff'}} />
                              <Typography variant='h5' sx={{fontSize: '24px', fontWeight: 300}}>
