            ...
            <motion.div className="page-background" style={{ textAlign: 'left', height: '100%', padding: "5vh 5%"}}>
              ...
              <Reveal index={1.5}>
                  <Typography variant="body1" sx={{mb: '6vh'}}>
                     CWRU Girls Who Code members are very excited to be providing <strong>free semester-long programs </strong> to introduce middle school and high school students to basic programming and problem-solving skills. Currently, we are seeking students in the Cleveland area for our programs this spring. Our goal is to help close the gender gap in technology and computer science. We are excited to continue teaching our Intro to Python and Intro to Arduino sessions! All students are welcome to participate.
